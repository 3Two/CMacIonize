 ...
 */
#ifndef DUSTPHOTONSHOOTJOBMARKET1_HPP
#define DUSTPHOTONSHOOTJOBMARKET1_HPP

#include "Configuration.hpp"
#include "DustPhotonShootJob1.hpp"
#include "Lock.hpp"
 ...
 * DensityGrid.
 */
class DustPhotonShootJobMarket1 {
private:
  /*! @brief Per thread DustPhotonShootJob. */
  DustPhotonShootJob1 *_jobs[MAX_NUM_THREADS];
...
public:
   ...
   */
  inline DustPhotonShootJobMarket1(PhotonSource &photon_source,
    ...
    for (int_fast32_t i = 0; i < _worksize; ++i) {
      _jobs[i] = new DustPhotonShootJob1(photon_source, dust_scattering,
                                        random_seed + i, density_grid);
    }
  }
   ...
   */
  inline ~DustPhotonShootJobMarket1() {
    for (int_fast32_t i = 0; i < _worksize; ++i) {
      delete _jobs[i];
    }
  }
   ...
   */
  inline DustPhotonShootJob1 *get_job(int_fast32_t thread_id) {
...
#endif // DUSTPHOTONSHOOTJOBMARKET1_HPP
