...
#include "DustPhotonShootJobMarket1.hpp"
...
int DustSimulation::do_simulation(CommandLineParser &parser, bool write_output,
  ...
  HomogeneousDensityFunction density_function(params, log);
  ...
  SingleStarPhotonSourceDistribution continuoussource(params, log);
  ...
  PhotonSource source( &continuoussource, &continuousspectrum, nullptr, nullptr,
  ...
  WorkDistributor< DustPhotonShootJobMarket1, DustPhotonShootJob1 >
